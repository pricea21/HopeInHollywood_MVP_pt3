        ...
        if (hittable)
        {
            ...
            switch (moleType)
            {
                ...
                case MoleType.HardHat:
                    ...
                    {
                        spriteRenderer.sprite = BeyonceHit;
                        gameManager.AddScore(moleIndex);
                        // Stop the animation
                        StopAllCoroutines();
                        StartCoroutine(QuickHide());
